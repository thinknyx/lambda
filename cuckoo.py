...
FROM_ADDRESS='ravi.singh@thinknyx.com'
REPLY_TO_ADDRESS='ravi.singh@thinknyx.com'
...
def get_template_from_s3(key):
    ...
    s3 = boto3.client('s3')
    s3_file = s3.getobject(Bucket = test-medidata-templates2, Key = key)
    try:
